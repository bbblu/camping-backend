...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private void configRequestAuthorize(HttpSecurity http) throws Exception {
        http.authorizeRequests() // 設定Requests的權限需求
                ...
                .antMatchers(HttpMethod.POST, "/product-group/**").authenticated()
                .antMatchers(HttpMethod.DELETE, "/product-group/**").authenticated()
                .antMatchers(HttpMethod.PATCH, "/product-group/**").authenticated()
