...
public class ProductBean {
    ...
    @Positive(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, message = "商品類型 - 應為大於0的正數")
    ...
    @Size(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, max = 200, message = "商品名稱 - 輸入字數大於{max}個字")
    private String name;

    @Schema(description = "數量", example = "1")
    @NotNull(groups = {CreateProductGroup.class, CreateProduct.class}, message = "數量 - 未填寫")
    @Positive(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, message = "數量 - 應為大於0的正數")
    private Integer count;

    @Schema(description = "品牌", example = "雜牌")
    @NotBlank(groups = {CreateProductGroup.class, CreateProduct.class}, message = "品牌 - 未填寫")
    @Size(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, max = 100, message = "品牌 - 輸入字數大於{max}個字")
    ...
    @Size(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, max = 500, message = "外觀狀況 - 輸入字數大於{max}個字")
    ...
    @Size(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, max = 100, message = "損壞賠償 - 輸入字數大於{max}個字")
    ...
    @URL(groups = {CreateProductGroup.class, CreateProduct.class, UpdateProductGroup.class, UpdateProduct.class}, message = "相關連結 - 有連結的格式不符合網址連結的格式")
